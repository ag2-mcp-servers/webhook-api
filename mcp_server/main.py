...
from models import (
    ...
    WebhookWebhooksIdExecuteServiceIdPostRequest,
    WebhookWebhooksIdXServiceIdPostRequest,
    WebhookWIdServiceIdPostRequest,
)
...
def event_logs_all(
    ...
    filter: Optional[WebhookEventLogsFilter] = None,
):
    """
    List event logs
    """
...
@app.post(
    ...
    tags=['webhook_management', 'webhook_execution'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
def webhooks_resolve(
    id: str,
    service_id: str = Path(..., alias='serviceId'),
    e: Optional[str] = None,
    body: WebhookWIdServiceIdPostRequest = ...,
):
    """
...
def webhooks_delete(
    id: str, x_apideck_app_id: str = Header(..., alias='x-apideck-app-id')
):
    """
...
@app.post(
    ...
    tags=['webhook_execution', 'webhook_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
def webhooks_execute(
    id: str,
    service_id: str = Path(..., alias='serviceId'),
    body: WebhookWebhooksIdExecuteServiceIdPostRequest = ...,
):
    """
    Execute a webhook
    """
...
def webhooks_short_execute(
    id: str,
    service_id: str = Path(..., alias='serviceId'),
    l_id: Optional[str] = None,
    e: Optional[str] = None,
    body: WebhookWebhooksIdXServiceIdPostRequest = ...,
):
    """
    Execute a webhook
    """
